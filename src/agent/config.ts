...
export const CONFIG = {
  ...
  analyze: { limitPerRun: 15, maxRetries: 3, windowDays: 2, phaseTimeoutMs: 45_000 },
  ...
  narrative: { matchThreshold: 0.35, minClusterSize: 3, staleDays: 7, archiveDays: 14, maxArticles: 100, phaseTimeoutMs: 30_000 },
