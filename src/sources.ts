...
export const RSS_SOURCES: RssSource[] = [
  ...
  { name: 'V2EX 热榜',   url: 'https://www.v2ex.com/feed/tab/hot.xml',  lang: 'zh', weight: 0.7 },
  ...
  { name: 'GitHub Trending', url: 'https://github.com/trending/rss?since=daily',  lang: 'en', weight: 0.7 },
